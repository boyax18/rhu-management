...
// Fetch all health check up patients
$sql = "SELECT id, name, age, date_recorded FROM healthcheck_patients ORDER BY id DESC";
          ...
          <tbody>
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><button class='view-btn' onclick=\"alert('Patient ID: ".$row['id']."')\">View</button></td>";
                    echo "</tr>";
                }
            } else {
